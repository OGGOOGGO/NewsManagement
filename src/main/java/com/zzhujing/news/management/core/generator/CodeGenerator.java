package com.zzhujing.news.management.core.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/news-management?useUnicode=true&useSSL=false&characterEncoding=utf8");
